...
/**
 * Protobuf type <code>Cinexpert.Messages.ResourceUpdateRequest.ResourceType</code>
 */
class ResourceType
{
    /**
...
class_alias(ResourceType::class, \Cinexpert\Messages\ResourceUpdateRequest_ResourceType::class);
